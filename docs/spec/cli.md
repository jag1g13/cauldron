...
- Additional `[container] mounts`, `[container] ports`, and `[container] known_hosts` from the configuration are applied to the container, including any Git or SSH agent mounts declared by the user.
